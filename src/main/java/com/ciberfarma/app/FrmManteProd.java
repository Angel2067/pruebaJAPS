...
public class FrmManteProd extends JFrame {
	...
	List<Producto> lstCategorias = em.createQuery("select p from Producto p").getResultList();
	
	
		txtSalida.append("");

        for (Producto p : lstProductos) {
        	txtSalida.append((p.getId_prod() + "" + p.getDes_prod() + "" + p.getStk_prod() + "" + p.getPre_prod() + "" + p.getIdcategoria() + "\n"));
